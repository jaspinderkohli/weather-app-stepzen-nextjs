...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-r from-[#394F68] to-[#183B7E] p-10 flex flex-col justify-center items-center">
      <Card className='max-w-4xl mx-auto'>
        ...
        <Card className='bg-gradient-to-r from-[#394F68] to-[#183B7E]'>
          {/* CityPicker */}
        </Card>
      </Card>
